  ...
  return (
    <section className="h-screen xl:h-[1600px] overflow-x-clip relative ">
      ...
      <div className="container mx-auto h-full flex items-center xl:items-start ">
        ...
        text-center fixed left-0 right-0 mt-24 xl:mt-[160px]"
          style={{
            opacity: textOpacity,
            scale: textScale,
            display: textDisplay,
        ...
        >
          <h1 className="text-[60px] font-bold max-w-[800px] xl:max-w-max">
            {BASIC_DATA.title}
          </h1>
          ...
          <Button btnText={BASIC_DATA.btnText} />
        </motion.div>

        {/* img */}
        <motion.div
          className="hidden xl:flex w-full max-w-[960px] mx-auto h-[520px]
      bg-no-repeat sticky left-0 right-0"
          style={{
